...
[نسخه فارسی](https://github.com/ATOung/v2ray-worker/blob/main/README.md)
...
[![Deploy to Cloudflare Workers](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/ATOung/v2ray-worker)
